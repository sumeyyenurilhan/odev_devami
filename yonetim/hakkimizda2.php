<?php
    ...
    if ($_POST) {
        ...
        $sorgu = $baglan->query("delete from hakkimizda2");
        $sorgu = $baglan->query("insert into hakkimizda2 (aciklama) values ('$aciklama')");
        echo "<script> window.location.href='hakkimizda2.php'; </script>";
    }

    $sorgu = $baglan->query("select * from hakkimizda2");
...
<html>
    ...
    <div style="text-align:center;">
        ...
        <br><hr><br>
        <div style="text-align:center;">
            <a href="hakkimizda1.php">Vizyon ve Misyonumuz</a><a href="hakkimizda2.php" class="active">Seyahat Rehberi</a><a href="hakkimizda3.php">Gereklilikler</a>
        </div>
