<?php
    ...
    if ($_POST) {
        ...
        $sorgu = $baglan->query("delete from hakkimizda1");
        $sorgu = $baglan->query("insert into hakkimizda1 (aciklama) values ('$aciklama')");
        echo "<script> window.location.href='hakkimizda1.php'; </script>";
    }

    $sorgu = $baglan->query("select * from hakkimizda1");
...
<html>
    ...
    <div style="text-align:center;">
        ...
        <br><hr><br>
        <div style="text-align:center;">
            <a href="hakkimizda1.php" class="active">Vizyon ve Misyonumuz</a><a href="hakkimizda2.php">Seyahat Rehberi</a><a href="hakkimizda3.php">Gereklilikler</a>
        </div>
