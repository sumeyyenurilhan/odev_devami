<?php
    ...
    if ($islem == "sil") {
        $id = $_GET["id"];
        $sorgu = $baglan->query("delete from anasayfa_gezig where (id='$id')");
        echo "<script> window.location.href='anasayfa_gezig.php'; </script>";
    }
    ...
    if ($islem == "ekle") {
        ...
        $yazi = $_POST["yazi"];
        $sorgu = $baglan->query("insert into anasayfa_gezig (baslik,resim,yazi) values ('$baslik','../$resim','$yazi')");
        echo "<script> window.location.href='anasayfa_gezig.php'; </script>";
    }
?>
<!doctype html>
    ...
    <table>
        ...
        while ($satir = $sorgu->fetch_object()) {
            ...
            echo "<tr>
                ...
                <td>$satir->resim</td>
                <td>$satir->yazi</td>
                <td><a href='anasayfa_gezig.php?islem=sil&id=$satir->id' class='a'>SİL</td>
                </tr>";
        }
        ?>
        </table><br>
        <form action="anasayfa_gezig.php?islem=ekle" enctype="multipart/form-data" method="post">
